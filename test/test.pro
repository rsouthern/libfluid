...
linux:LIBS += -L${CUDA_PATH}/lib64 -L${CUDA_PATH}/lib64/nvidia -L$$LIB_INSTALL_DIR -L/usr/lib/x86_64-linux-gnu -L/usr/lib64/nvidia -lfluid -lcuda -lcudart -lcudadevrt -lcurand
QMAKE_RPATHDIR += ../lib
